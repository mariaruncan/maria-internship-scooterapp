...
class PageFragment : Fragment(R.layout.fragment_onboarding_page) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.pageIV.setImageDrawable(fromIntToPage(pageNumber))
    ...
    private fun fromIntToPage(pageNr: Int?) = when (pageNr) {
